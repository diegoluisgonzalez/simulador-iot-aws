...
& $python3 aws-iot-device-sdk-python-v2\samples\mqtt\mqtt5_x509.py --endpoint axzmbfedjc2w3-ats.iot.us-east-1.amazonaws.com --cert Invernadero_01.cert.pem --key Invernadero_01.private.key --client_id basicPubSub --topic sdk/test/python --count 0